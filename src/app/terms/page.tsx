      ...
      <div className="space-y-6 text-sm">
        {[
          ...
          },
          {
            ...
            content: 'Το σύνολο του περιεχομένου (άρθρα, εικόνες, κείμενα, λογότυπα) ανήκει στο ΑΙΣΧΟΛΙΑΣΜΟΣ ή σε τρίτους με άδεια. Απαγορεύεται η αναπαραγωγή χωρίς γραπτή άδεια. Επιτρέπεται η κοινοποίηση με αναφορά πηγής και hyperlink.',
          },
          {
            title: '3. Χρήση Περιεχομένου',
            content: 'Το περιεχόμενο παρέχεται για ενημερωτικούς σκοπούς. Δεν αποτελεί επαγγελματική συμβουλή (νομική, οικονομική, ιατρική). Το ΑΙΣΧΟΛΙΑΣΜΟΣ δεν φέρει ευθύνη για αποφάσεις που λαμβάνονται βάσει του περιεχομένου.',
          },
          {
          ...
          },
          {
            ...
            content: 'Το ΑΙΣΧΟΛΙΑΣΜΟΣ παρέχει τον ιστότοπο "ως έχει" χωρίς εγγυήσεις. Δεν φέρουμε ευθύνη για τυχόν απώλειες ή ζημιές από τη χρήση ή την αδυναμία χρήσης του ιστότοπου.',
          },
          {
            title: '6. Cookies',
