...
export const metadata: Metadata = {
  title: 'Συντακτική Πολιτική | ΑΙΣΧΟΛΙΑΣΜΟΣ',
  description:
    'Οι αρχές, τα πρότυπα και οι διαδικασίες που διέπουν τη δημοσιογραφική μας πρακτική στο ΑΙΣΧΟΛΙΑΣΜΟΣ.',
...
const sections = [
  {
    ...
    content: `Το ΑΙΣΧΟΛΙΑΣΜΟΣ δεσμεύεται στην παροχή αξιόπιστης, έγκαιρης και αναλυτικής δημοσιογραφίας για AI, τεχνολογία, οικονομία και επικαιρότητα. Στόχος μας δεν είναι απλώς να αναφέρουμε γεγονότα, αλλά να τα εξηγούμε με πλαίσιο και να βοηθούμε τους αναγνώστες να τα κατανοήσουν.`,
  },
  {
  ...
  },
  {
    ...
    content: `Για συντακτικά θέματα, παρατηρήσεις ή διορθώσεις, επικοινωνήστε με τη σύνταξη στο editorial@aisxoliasmos.gr. Απαντάμε εντός 2 εργάσιμων ημερών.`,
  },
];
