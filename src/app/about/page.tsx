      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed">
            <p>
              Τα άρθρα του {BRAND.name} γράφονται και επιμελούνται από πραγματικούς συντάκτες, οι
              οποίοι υπογράφουν το περιεχόμενο και αναλαμβάνουν την ευθύνη για τις ενημερώσεις και
              τις διορθώσεις του.
            </p>
            <p>
              Οι πληροφορίες αξιολογούνται, διασταυρώνονται όπου αυτό είναι δυνατό και
              παρουσιάζονται με τρόπο κατανοητό για τον αναγνώστη. Όταν ένα δημοσίευμα βασίζεται
              σε πληροφορίες άλλου μέσου, επίσημη ανακοίνωση ή εξωτερική πηγή, η προέλευση της
              πληροφορίας αναφέρεται με σαφήνεια.
            </p>
          </div>
        </section>
